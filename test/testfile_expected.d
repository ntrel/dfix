...
alias PTCH = TCHAR*, PTBYTE = TCHAR*, LPTCH = TCHAR*, PTSTR = TCHAR*, LPTSTR = TCHAR*, LP = TCHAR*, PTCHAR = TCHAR*;
alias PCTCH = const(TCHAR)*, LPCTCH = const(TCHAR)*, PCTSTR = const(TCHAR)*, LPCTSTR = const(TCHAR)*;
